  ...
  return (
    <div className="min-h-screen bg-lawfirm-cream">
      ...
      <header className="relative">
        {/* Navigation */}
        <nav className="absolute top-0 left-0 right-0 z-50 flex justify-between items-center w-full px-18 py-5">
      ...
      >
        <div className="w-full px-18 py-15 flex flex-col items-center gap-16">
          <div className="flex items-start gap-33 w-full">
