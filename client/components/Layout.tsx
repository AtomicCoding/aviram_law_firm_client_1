          ...
          <div className="bg-white rounded-lg max-w-md w-full max-h-[90vh] overflow-y-auto">
            <div className="p-6">
              <div className="flex justify-between items-center mb-6">
                <h3 className="text-lawfirm-brown font-bold text-2xl font-['Mulish']">
                  Free Consultation
                </h3>
                <button
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  <div>
                    ...
                    <input
                      ...
                      name="name"
                      required
                      className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:border-lawfirm-brown font-['Inter']"
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      rows={4}
                      className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:border-lawfirm-brown font-['Inter']"
                      placeholder="Please describe your case and how we can help you"
                    ></textarea>
                  </div>
    ...
    <div className="min-h-screen bg-lawfirm-cream">
      ...
      <header className="relative">
        ...
        <nav className="absolute top-0 left-0 right-0 z-50 flex justify-between items-center w-full px-4 md:px-16 lg:px-20 py-5">
          ...
          <div className="flex justify-center items-center gap-1 absolute left-1/2 transform -translate-x-1/2">
            {/* Logo */}
